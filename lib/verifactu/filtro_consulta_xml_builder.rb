    ...
    def self.agregar_filtro_consulta(xml_document_root, filtro_consulta)
      ...
      if filtro_consulta.fecha_expedicion_factura
        ...
        if filtro_consulta.fecha_expedicion_factura.fecha_expedicion
          ...
          fecha_expedicion_factura_sub_element.content = filtro_consulta.fecha_expedicion_factura.fecha_expedicion
      ...
      if filtro_consulta.sistema_informatico
        ...
        sistema_informatico_numero_instalacion_element = Nokogiri::XML::Node.new('sum:NumeroInstalacion', xml_document_root)
        ...
        sistema_informatico_tipo_uso_posible_solo_verifactu_element = Nokogiri::XML::Node.new('sum:TipoUsoPosibleSoloVerifactu', xml_document_root)
        ...
        sistema_informatico_tipo_uso_posible_multi_ot_element = Nokogiri::XML::Node.new('sum:TipoUsoPosibleMultiOT', xml_document_root)
        ...
        sistema_informatico_indicador_multiples_ot_element = Nokogiri::XML::Node.new('sum:IndicadorMultiplesOT', xml_document_root)
