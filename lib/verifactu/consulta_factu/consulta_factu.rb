  ...
  module ConsultaFactu
    class Consulta
      ...
      def initialize(cabecera, filtro_consulta, datos_adicionales_respuesta = nil)
        ...
        raise Verifactu::VerifactuError, "Cabecera must be an instance of Verifactu::ConsultaFactu::CabeceraConsulta" unless cabecera.is_a?(Verifactu::ConsultaFactu::CabeceraConsulta)
        ...
        # DatosAdicionalesRespuesta es minOccurs="0" en ConsultaLR.xsd -> opcional
        raise Verifactu::VerifactuError, "Datos adicionales de respuesta must be an instance of Verifactu::ConsultaFactu::DatosAdicionalesRespuesta" if datos_adicionales_respuesta && !datos_adicionales_respuesta.is_a?(Verifactu::ConsultaFactu::DatosAdicionalesRespuesta)
        @cabecera = cabecera
