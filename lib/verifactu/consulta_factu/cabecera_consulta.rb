module Verifactu
  module ConsultaFactu
    class CabeceraConsulta
      ...
      def cabecera_obligado_emisor(obligado_emision, indicador_representante = nil)
        ...
        @fecha_expedicion_factura.instance_variable_set(:@obligado_emision, obligado_emision)
      end

      def cabecera_destinatario(destinatario, indicador_representante = nil)
        ...
        @cabecera = new(indicador_representante)
        @fecha_expedicion_factura.instance_variable_set(:@destinatario, destinatario)
      end
