  ...
  module RegistroFacturacion
    ...
    class ImporteRectificacion
      ...
      def initialize(base_rectificada:, cuota_rectificada:, cuota_recargo_rectificado: nil)
        ...
        raise Verifactu::VerifactuError, "cuota_recargo_rectificado debe tener como mucho 12 dígitos antes del decimal y dos decimales" unless VERIFACTU::Helper::Validador.validar_digito(cuota_recargo_rectificado)
