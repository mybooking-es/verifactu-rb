module Verifactu
  ...
  class RegistroAltaBuilder
    ...
    #
    def con_id_factura(id_emisor_factura:, num_serie_factura:, fecha_expedicion_factura:)
      @id_factura = Verifactu::RegistroFacturacion::IDFactura.new(id_emisor_factura: id_emisor_factura,
